...
// PodScalingReconciler reconciles a PDBWatcher object
...
func (r *PodScalingReconciler) conflicts(ctx context.Context, pdbWatcher *myappsv1.PDBWatcher) error {
...
func (r *PodScalingReconciler) discoverDeployment(ctx context.Context, pdb *policyv1.PodDisruptionBudget) (string, error) {
	logger := log.FromContext(ctx)
